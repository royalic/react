...
thirdnum2:[],forthnum1:[],forthnum2:[],fifthnum1:[],fifthnum2:[],name:[],value:[],lists:[],sss1:[0],sss2:[0],sss3:[0],inp:[],inp1:[],inp2:[],tim:[],nametest:[],valuetest:[],time:[],paytimes:'赔率：0',info:[0],nopay:[1],numpaytimes:[]}
    }  
...
if(e==4){//eslint-disable-line
  lists.push('02','05','08','11','14','17','20','23','26','29','32','35','38');
  for (i=0; i < lists.length; i++) {              
        for (p = i + 1; p < lists.length; p++) {
            if (+lists[i]===+lists[p]) {
                lists.splice(p, 1);
...
if(e==5){//eslint-disable-line
  lists.push('01','04','07','10','12','16','19','22','25','28','31','34','37');
  for (i=0; i < lists.length; i++) {              
        for (p = i + 1; p < lists.length; p++) {
            if (+lists[i]===+lists[p]) {
                lists.splice(p, 1);
...
if(e==6){//eslint-disable-line
  lists.push('03','06','09','15','15','18','21','24','27','30','33','36','39');
  for (i=0; i < lists.length; i++) {              
        for (p = i + 1; p < lists.length; p++) {
            if (+lists[i]===+lists[p]) {
                lists.splice(p, 1);
    ...
    <div className='col right'>
     ...
     <div className='col center'>
       ...
       <form action="http://127.0.0.1:8081/commit" method='post'>
        ...
        <div className='col game3'>
          <div>
            <div className='col game3'>三中二：</div><div className='col game3'>{this.state.sss2}碰</div>
            <input type='text' className='col game3 starnum'
name='threestarmoney' onChange={this.inputvalue1.bind(this)} defaultValue='0'/>
          </div>         
         </div>
       </div>
         <textarea name='allnum' value={this.state.lists} readOnly={true}/><input type='button' onClick={this.delete} value='清除' readOnly={true}/>
         <input type="submit" value='提交数据' onClick={this.money} readOnly={true}/>   <input type='text' name='name' value={this.state.name}  className='superstyle' readOnly={true}/><input type='text' name='time' value={this.state.time}  className='superstyle' readOnly={true}/><input type='text' name='type' value='5393x2'  className='superstyle' readOnly={true}/><input type='text' name='twostarnum' value='0'  className='superstyle' readOnly={true}/><input type='text' name='fourstarnum' value='0'  className='superstyle' readOnly={true}/><input type='text' name='twostarmoney' value='0'  className='superstyle' readOnly={true}/><input type='text' name='fourstarmoney' value='0'  className='superstyle' readOnly={true}/><input type='text' name='threestarnum' value={this.state.sss2}  className='superstyle' readOnly={true}/><input type='text' name='nopay' value={this.state.nopay}  className='superstyle' readOnly={true}/>
    </form>
    </div>
