...
secondnum2:[],thirdnum1:[],thirdnum2:[],forthnum1:[],forthnum2:[],fifthnum1:[],
fifthnum2:[],name:[],value:[],lists:[],sss1:[0],sss2:[0],sss3:[0],inp:[],inp1:[],inp2:[],
tim:[],nametest:[],valuetest:[],time:[],paytimes:'赔率：0',info:[0],nopay:[1],numpaytimes:[]}
    }  
   getData(){                                              //get the last of winning numbers
...
,forthnum1:data[0].forthnum,fifthnum1:data[0].fifthnum,link2:data[1].link,
...
add(e){                                                   //single number added
  ...
  for(m1=0;m1<n.length;m1++){
      if(n[m1]==']'){m2=m1}}//eslint-disable-line
  for(m1=0;m1<n.length;m1++){
      if(m1<m2){
              ...
              <div>头号：<Select defaultValue="" style={{ width: 120 }} onChange={this.add1}>
               ...
               <div>生肖：<Select defaultValue="" style={{ width: 120 }} onChange={this.add3.bind(this)}>
                ...
                <div>其他：<Select defaultValue="" style={{ width: 120 }} onChange={this.add4.bind(this)}>
                 ...
                 <input type='button' className='backblue' name="add3" onClick={this.team} value='二星组选完'/>
        </div>
        <div className='col game3'>
          <div className='flex'>
            <div className='col game3'>三星：</div><div className='col game3'>{this.state.sss2}碰</div>
            <input type='text' className='col game3 starnum'
name='threestarmoney' onChange={this.inputvalue1.bind(this)} defaultValue='0'/>
          </div>         
         </div>
       </div>
         <textarea name='allnum' value={this.state.lists} readOnly={true}/><input type='button' onClick={this.delete} value='清除'/>
         <input type="submit" value='提交数据' onClick={this.money}/>   <input type='text' name='name' value={this.state.name}  className='superstyle' readOnly={true}/><input type='text' name='time' value={this.state.time}  className='superstyle' readOnly={true}/><input type='text' name='type' value='539sxlzp'  className='superstyle' readOnly={true}/><input type='text' name='twostarnum' value='0'  className='superstyle' readOnly={true}/><input type='text' name='fourstarnum' value='0'  className='superstyle' readOnly={true}/><input type='text' name='twostarmoney' value='0'  className='superstyle' readOnly={true}/><input type='text' name='fourstarmoney' value='0'  className='superstyle' readOnly={true}/><input type='text' name='threestarnum' value={this.state.sss2}  className='superstyle' readOnly={true}/><input type='text' name='nopay' value={this.state.nopay}  className='superstyle' readOnly={true}/>
    </form>
    </div>
