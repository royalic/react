...
thirdnum2:[],forthnum1:[],forthnum2:[],fifthnum1:[],fifthnum2:[],name:[],value:[],lists:[],sss1:[0],sss2:[0],sss3:[0],inp:[],inp1:[],inp2:[],tim:[],nametest:[],valuetest:[],time:[],paytimes:'赔率：0',info:[0],nopay:[1]}
    }  
...
if(e==2){//eslint-disable-line
        window.location.href = "/#/taiwanlotto5392xs/"                                         
}
if(e==3){//eslint-disable-line
...
name='twostarmoney' onChange={this.inputvalue1.bind(this)} defaultValue='0'/>
          </div>         
         </div>
       </div>
