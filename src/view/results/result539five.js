...
var results = () => new Promise(function(resolve,reject){
   ...
   results2().then(function(value2){                        //arr is the array of user's numbers
       ...
       if(value[o].type=='539slp'&&value[o].time==value2[0].link){
       var z1=value[o].fourstarmoney;
       var zz1=value[o].id;
       var i;
       var t=0;
       var t1=0;
    ...
    connection.query(
      ...
      for(i=0;i<arr3star.length;i++){
       ...
       if(t1==2&&t2==3){
        ...
        console.log(z);
        connection.query(
        "update payinfo set getcount=?,getmoney=? where id=? and time=?",[t,z.toFixed(2),zz1,value2[0].link],
        function select(err, results) {
            if (results) {
            }
            if (err) {
...
exports.result539five=result539five;
