...
var results = () => new Promise(function(resolve,reject){
   ...
   results2().then(function(value2){
    ...
    for (o=0; o<value.length;o++){
      ...
      if(t==3){
          z=z1*75.6*3+z2*890*1;}
      if(t==4){
          z=z1*75.6*6+z2*890*4+z3*13500*1;}
      if(t==5){
          z=z1*75.6*10+z2*890*10+z3*13500*5;}
      if(t==6){
          z=z1*75.6*15+z2*890*20+z3*13500*15;}
      connection.query(
...
exports.resultoneone=resultoneone;
