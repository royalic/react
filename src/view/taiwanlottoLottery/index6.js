...
add(e){                                                              //single number added
  ...
  console.log(all2.length,all1.length);                   
  var dd='四星赔率：13500'; 
...
name='threestarmoney' onChange={this.inputvalue1.bind(this)} defaultValue='0'/>
         ...
         <input type="submit" value='提交数据' onClick={this.money}/>   <input type='text' name='name' value={this.state.name}  className='superstyle' readOnly={true}/><input type='text' name='time' value={this.state.time}  className='superstyle' readOnly={true}/><input type='text' name='type' value='slp'  className='superstyle' readOnly={true}/><input type='text' name='twostarnum' value='0'  className='superstyle' readOnly={true}/><input type='text' name='fourstarnum' value='0'  className='superstyle' readOnly={true}/><input type='text' name='twostarmoney' value='0'  className='superstyle' readOnly={true}/><input type='text' name='fourstarmoney' value='0'  className='superstyle' readOnly={true}/><input type='text' name='threestarnum' value={this.state.sss2}  className='superstyle' readOnly={true}/><input type='text' name='nopay' value={this.state.nopay}  className='superstyle' readOnly={true}/>
    </form>
    </div>
