...
supernum2:[],name:[],value:[],lists:[],sss1:[0],sss2:[0],sss3:[0],inp:[],inp1:[],inp2:[],tim:[],nametest:[],valuetest:[],time:[],paytimes:'赔率：0',info:[0],seconds:[],nopay:[1]}
    }  
     ...
     <div className='col center'>
       ...
       <form action="http://127.0.0.1:8081/commit" method='post'>
        ...
        <div className='col game3'>
         ...
         <input type="submit" value='提交数据' onClick={this.money}/>   <input type='text' name='name' value={this.state.name}  className='superstyle' readOnly={true} /><input type='text' name='time' value={this.state.time}  className='superstyle' readOnly={true} /><input type='text' name='type' value='LPKS'  className='superstyle' readOnly={true} /><input type='text' name='nopay' value={this.state.nopay}  className='superstyle' readOnly={true} />
    </form>
    </div>
